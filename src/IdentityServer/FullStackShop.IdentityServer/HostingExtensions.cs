...
using FullStackShop.IdentityServer;
using FullStackShop.IdentityServer.Pages.Admin.ApiScopes;
using FullStackShop.IdentityServer.Pages.Admin.Clients;
using FullStackShop.IdentityServer.Pages.Admin.IdentityScopes;
...
internal static class HostingExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        // this adds the necessary config for the simple admin/config pages
        {
            ...
            builder.Services.AddTransient<FullStackShop.IdentityServer.Pages.Portal.ClientRepository>();
